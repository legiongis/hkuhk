"""
Django settings for hkuhk project.
"""
...
SECRET_KEY = 'wxrz7emk&8*gy^bp-i-#(gct&1_1e00x9yn5=+5ki@$*=v(m^p'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'hkuhk.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'hkuhk'
...
WSGI_APPLICATION = 'hkuhk.wsgi.application'
